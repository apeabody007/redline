...
VERSION="${VERSION:-1.4}"   # scripts/release.sh passes the release version in
...
if [[ "${1:-}" == "test" ]]; then
  ...
  swiftc -O Sources/Metrics.swift Sources/Sensors.swift Sources/TopApps.swift build/tests/main.swift \
